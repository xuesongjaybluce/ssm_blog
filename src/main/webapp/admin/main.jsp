    ...
    <script>
        function openTab(text,url,iconCls){
            if($("#tabs").tabs("exists",text)){
                ...
                var content = "<iframe frameborder=0 style='width:100%;height:500px;' src='" + url + "'></iframe>'";
                $("#tabs").tabs("add",{
                    title:text,
                    iconCls:iconCls,
                    closable:true,
...
<div region="west" title="导航菜单" style="width:150px;padding:0;overflow: hidden;">
    <div class="easyui-accordion" style="width:150px;">
        <div title="常用操作" iconCls="icon-2012080404391" style="overflow: hidden;margin:0;">
            ...
            <a href="javascript:openTab('评论审核','${pageContext.request.contextPath}/admin/commentAudit.jsp','icon-review')" class="easyui-linkbutton" plain="true" iconCls="icon-review"  style="width: 150px">评论审核</a>
        </div>
        <div title="博客管理" iconCls="icon-blog" style="overflow: hidden;margin:0;">
            <a href="javascript:openTab('写博客','${pageContext.request.contextPath}/admin/writeBlog.jsp','icon-writeblog')" class="easyui-linkbutton" plain="true" iconCls="icon-writeblog" style="width: 150px">写博客</a>
            <a href="javascript:openTab('博客信息管理','${pageContext.request.contextPath}/admin/manageBlog.jsp','icon-bkgl')" class="easyui-linkbutton" plain="true" iconCls="icon-bkgl"  style="width: 150px">博客信息管理</a>
        </div>
        <div title="博客类别管理" iconCls="icon-2012080111634" style="overflow: hidden;margin:0;">
            <a href="javascript:openTab('博客类别信息管理','${pageContext.request.contextPath}/admin/manageBlogType.jsp','icon-bklb')" class="easyui-linkbutton" plain="true" iconCls="icon-bklb"  style="width: 150px">博客信息管理</a>
        </div>
...
<div id="content" region="center" title="系统管理" style="padding:5px;">
